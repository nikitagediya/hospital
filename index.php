...
<head>
    ...
    <title> Hospitality Service Provider System </title>
...
<body>
    ...
    <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">HSPS
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Hospitality Service Provider System</h5>
    ...
    <div class="copy">
        <div class="container">
            Hospitality Service Provider System
